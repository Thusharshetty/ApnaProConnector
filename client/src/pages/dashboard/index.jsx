...
export default function Dashboard() {
    ...
    const handleUplaod = async () => {
        const res = await dispatch(createPost({ file: fileContent, body: postContent }));
        if (postsState.isSuccess && !postsState.isError) {
                                                ...
                                                <div>
                                                    <div className={styles.postHeader}>
                                                        ...
                                                        {post.userId._id === authState.user.userId._id &&
                                                            <svg id={styles.deleteIcon}
                                                                onClick={async (e) => {
                                                                    try {
                                                                        // Dispatch the action and unwrap the promise to catch potential HTTP/API rejections
                                                                        const result = await dispatch(deletePost({ post_id: post._id })).unwrap();
